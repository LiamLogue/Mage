...
namespace Mage
{
    class HealthTotem
    {
        ...
        public HealthTotem(Texture2D pTexture)
        {
            //Set the texture and make our health totem invisible
            this.healthTotemTexture = pTexture;
            isVisible = false;
        }
        #endregion
        ...
        {
            //Update the totem's rectangle
            rectangle = new Rectangle((int)pPlayerPos.X, (int)pPlayerPos.Y, healthTotemTexture.Width, healthTotemTexture.Height);
            borderRectangle = new Rectangle((int)pPlayerPos.X - 40, (int)pPlayerPos.Y - 35, healthTotemTexture.Width * 4, healthTotemTexture.Height * 4);

            //Draw the totem
            spriteBatch.Draw(healthTotemTexture, pPlayerPos, null, Color.White, 0.0f, origin, 1.0f, SpriteEffects.None, 0.0f);   
        }
        #endregion
